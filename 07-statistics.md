...
>> p(I) = (1/300)/(1/125+1/300) = 0.08
>> p(F) = (1/125)/(1/125+1/300) = 0.92
>> p(E|I) = 1 # if identical twin, it was definitely male
>> p(E|F) = 0.5 # if fraternal twin, half the time it is male
>> p(I|E) = (1)(0.08)/((1)(0.08)+(0.5)(0.92)) = 0.148
